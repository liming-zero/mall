...
CREATE TABLE `pms_attr`  (
  ...
  `attr_name` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `search_type` tinyint(4) NULL DEFAULT NULL,
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `value_select` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `attr_type` tinyint(4) NULL DEFAULT NULL COMMENT '属性类型[0-销售属性，1-基本属性，2-既是销售属性又是基本属性]',
  `enable` bigint(20) NULL DEFAULT NULL,
  `catelog_id` bigint(20) NULL DEFAULT NULL,
  `show_desc` tinyint(4) NULL DEFAULT NULL,
  `value_type` int(32) UNSIGNED NULL DEFAULT NULL,
...
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (2, '上市年份', 1, 'xxx', '2019', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (3, '入网型号', 1, 'xxx', 'LIO-AN00', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (4, '机身宽度（mm）', 1, 'xxx', '73.1mm', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (5, '机身重量（g）', 1, 'xxx', '198g', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (6, 'CPU品牌', 1, 'xxx', '以官网信息为准', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (7, 'GPU型号', 1, 'xxx', 'Mali G76', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (8, '屏幕材质类型', 1, 'xxx', 'OLED', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (9, '主屏幕尺寸', 1, 'xxx', '6.53英寸', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (10, '4G网络', 1, 'xxx', '4G FDD-LTE(联通);4G TD-LTE(移动);4G FDD-LTE(联通、电信)', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (11, '生物识别', 1, 'xxx', '人脸识别;屏幕光学指纹', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (12, '三防标准', 1, 'xxx', 'IP68', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (13, '颜色', 0, 'xxx', '亮黑色;星河银;翡冷翠;罗兰紫;丹霞橙', 0, 1, 225, 0, 1);
INSERT INTO `pms_attr` VALUES (14, '版本', 0, 'xxx', '5G全网通8GB+128;5G全网通8GB+256GB;4G全网通8GB+256GB;4G全网通8GB+128GB', 0, 1, 225, 0, 1);
...
CREATE TABLE `pms_attr_attrgroup_relation`  (
  ...
  `attr_group_id` bigint(20) NULL DEFAULT NULL,
  `attr_sort` int(11) NULL DEFAULT NULL,
...
INSERT INTO `pms_attr_attrgroup_relation` VALUES (6, 7, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (7, 8, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (8, 9, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (9, 10, 5, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (10, 11, 6, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (11, 12, 6, NULL);
...
CREATE TABLE `pms_attr_group`  (
  ...
  `attr_group_name` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1, '主体', 1, '主体信息', 'xxx', 225);
INSERT INTO `pms_attr_group` VALUES (2, '基本信息', 2, '商品基本信息', 'xxx', 225);
INSERT INTO `pms_attr_group` VALUES (3, '主芯片', 3, '主芯片', 'xxx', 225);
INSERT INTO `pms_attr_group` VALUES (4, '屏幕', 4, '屏幕', 'xxx', 225);
INSERT INTO `pms_attr_group` VALUES (5, '网络支持', 5, '网络支持', 'xxx', 225);
INSERT INTO `pms_attr_group` VALUES (6, '手机特性', 6, '手机特性', 'xxx', 225);
...
CREATE TABLE `pms_brand`  (
  `brand_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Ʒ',
  `name` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Ʒ',
  `logo` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Ʒ',
  `descript` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `show_status` tinyint(4) NULL DEFAULT NULL,
  `first_letter` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `sort` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`brand_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Ʒ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (2, '华为HUAWEI', 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-18/bb535a3d-4976-482b-8526-1430de23e7b0_huawei.png', '华为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (3, '小米', 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-18/9cec129d-4722-4a6f-881b-72f730e084c6_xiaomi.png', '小米', 1, 'X', 1);
INSERT INTO `pms_brand` VALUES (4, '苹果IPHONE', 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-18/ea8c2468-ca30-49b4-8a60-ff91d93d92d6_apple.png', '苹果', 1, 'P', 1);
INSERT INTO `pms_brand` VALUES (5, 'OPPO', 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-18/e6647676-e19c-460a-803b-253065b0c54c_oppo.png', 'OPPO', 1, 'O', 1);
...
CREATE TABLE `pms_category`  (
  ...
  `parent_cid` bigint(20) NULL DEFAULT NULL,
  `cat_level` int(11) NULL DEFAULT NULL,
  `show_status` tinyint(4) NULL DEFAULT NULL,
  `sort` int(11) NULL DEFAULT NULL,
  `icon` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ͼ',
  `product_unit` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `product_count` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`cat_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1433 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT 'Ʒ',
  `catelog_id` bigint(20) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Ʒ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (2, 2, 225, '华为HUAWEI', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (3, 3, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (4, 4, 225, '苹果IPHONE', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (5, 5, 225, 'OPPO', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (6, 2, 250, '华为HUAWEI', '平板电视');
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  `attr_value` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '˳',
  `quick_show` tinyint(4) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 63 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (12, 2, 2, '上市年份', '2019', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (13, 2, 3, '入网型号', 'LIO-AN00', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (14, 2, 4, '机身宽度（mm）', '73.1mm', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (15, 2, 5, '机身重量（g）', '198g', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (16, 2, 6, 'CPU品牌', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (17, 2, 7, 'GPU型号', 'Mali G76', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (18, 2, 8, '屏幕材质类型', 'OLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (19, 2, 9, '主屏幕尺寸', '6.53英寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (20, 2, 10, '4G网络', '4G FDD-LTE(联通);4G TD-LTE(移动);4G FDD-LTE(联通、电信)', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (21, 2, 11, '生物识别', '人脸识别;屏幕光学指纹', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (22, 2, 12, '三防标准', 'IP68', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (23, 3, 2, '上市年份', '2019', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (24, 3, 3, '入网型号', 'LIO-AN00', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (25, 3, 4, '机身宽度（mm）', '73.1mm', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (26, 3, 5, '机身重量（g）', '198g', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (27, 3, 6, 'CPU品牌', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (28, 3, 7, 'GPU型号', 'Mali G76', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (29, 3, 8, '屏幕材质类型', 'OLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (30, 3, 9, '主屏幕尺寸', '6.53英寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (31, 3, 10, '4G网络', '4G FDD-LTE(联通);4G TD-LTE(移动);4G FDD-LTE(联通、电信)', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (32, 3, 11, '生物识别', '人脸识别;屏幕光学指纹', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (57, 8, 2, '上市年份', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (58, 8, 3, '入网型号', 'A2404', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (59, 8, 6, 'CPU品牌', 'Apple', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (60, 8, 7, 'GPU型号', 'A13', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (61, 8, 8, '屏幕材质类型', 'OLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (62, 8, 9, '主屏幕尺寸', '6.1英寸', NULL, 1);
...
CREATE TABLE `pms_sku_images`  (
  ...
  `img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ͼƬ',
  `img_sort` int(11) NULL DEFAULT NULL,
  `default_img` int(11) NULL DEFAULT NULL COMMENT 'Ĭ',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 71 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'skuͼƬ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1, 13, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//34f5709c-7b9f-4805-83dd-b44177f937bf_2b1837c6c50add30.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (2, 13, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//8e2b617e-2216-4302-89da-2a3dd56cb0b6_28f296629cca865e.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (3, 13, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3508e663-03cf-481c-8c9c-b95c5139a654_8bf441260bffa42f.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (4, 14, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//8e2b617e-2216-4302-89da-2a3dd56cb0b6_28f296629cca865e.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (5, 14, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3508e663-03cf-481c-8c9c-b95c5139a654_8bf441260bffa42f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (6, 14, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//cfcbf295-41be-498c-8773-bea32c18a56e_fe215589ed6500f4.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (7, 15, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//34f5709c-7b9f-4805-83dd-b44177f937bf_2b1837c6c50add30.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (8, 15, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//8e2b617e-2216-4302-89da-2a3dd56cb0b6_28f296629cca865e.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (9, 15, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3508e663-03cf-481c-8c9c-b95c5139a654_8bf441260bffa42f.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (10, 16, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//34f5709c-7b9f-4805-83dd-b44177f937bf_2b1837c6c50add30.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (11, 16, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//8e2b617e-2216-4302-89da-2a3dd56cb0b6_28f296629cca865e.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (12, 16, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3508e663-03cf-481c-8c9c-b95c5139a654_8bf441260bffa42f.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (13, 17, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//478ecda4-9b81-402c-89d1-4a6980dd8b7e_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (14, 17, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//c9f736ab-8bfa-47ae-845b-951320a5f94f_919c850652e98031.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (15, 17, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//efcabdcf-0f10-499a-880f-0ad159591a97_d511faab82abb34b.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (16, 18, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//478ecda4-9b81-402c-89d1-4a6980dd8b7e_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (17, 18, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//c9f736ab-8bfa-47ae-845b-951320a5f94f_919c850652e98031.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (18, 18, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//efcabdcf-0f10-499a-880f-0ad159591a97_d511faab82abb34b.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (19, 19, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//478ecda4-9b81-402c-89d1-4a6980dd8b7e_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (20, 19, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//c9f736ab-8bfa-47ae-845b-951320a5f94f_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (21, 19, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//efcabdcf-0f10-499a-880f-0ad159591a97_d511faab82abb34b.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (22, 20, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//478ecda4-9b81-402c-89d1-4a6980dd8b7e_73ab4d2e818d2211.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (23, 20, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//c9f736ab-8bfa-47ae-845b-951320a5f94f_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (24, 20, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//efcabdcf-0f10-499a-880f-0ad159591a97_d511faab82abb34b.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (25, 21, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//78a19e33-5748-4275-8b5b-d4be53abd6e4_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (26, 21, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//073c6c6e-8b32-4cca-8b59-849189ef3356_23d9fbb256ea5d4a.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (27, 21, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//027160aa-b076-41f0-82c7-176d41c1d471_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (28, 22, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//78a19e33-5748-4275-8b5b-d4be53abd6e4_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (29, 22, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//073c6c6e-8b32-4cca-8b59-849189ef3356_23d9fbb256ea5d4a.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (30, 22, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//027160aa-b076-41f0-82c7-176d41c1d471_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (31, 23, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//073c6c6e-8b32-4cca-8b59-849189ef3356_23d9fbb256ea5d4a.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (32, 23, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//027160aa-b076-41f0-82c7-176d41c1d471_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (33, 23, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//cfcbf295-41be-498c-8773-bea32c18a56e_fe215589ed6500f4.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (34, 24, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//78a19e33-5748-4275-8b5b-d4be53abd6e4_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (35, 24, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//073c6c6e-8b32-4cca-8b59-849189ef3356_23d9fbb256ea5d4a.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (36, 24, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//027160aa-b076-41f0-82c7-176d41c1d471_b5c6b23d01dcdf81.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (37, 25, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3362084a-b1cd-46e7-8c51-573ef253f545_03c7bcc1f1e87699.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (38, 25, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//70000a19-e224-4a60-8544-4fc482534413_fe95370d6d0c8b62.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (39, 25, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//9b3866a8-3a67-4f01-82d2-3c63bdc35afe_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (40, 25, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//acb2cb00-10a7-4cf0-8eee-f1c731428634_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (41, 26, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3362084a-b1cd-46e7-8c51-573ef253f545_03c7bcc1f1e87699.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (42, 26, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//70000a19-e224-4a60-8544-4fc482534413_fe95370d6d0c8b62.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (43, 26, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//9b3866a8-3a67-4f01-82d2-3c63bdc35afe_b8494bf281991f94.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (44, 26, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//acb2cb00-10a7-4cf0-8eee-f1c731428634_a2c208410ae84d1f.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (45, 27, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3362084a-b1cd-46e7-8c51-573ef253f545_03c7bcc1f1e87699.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (46, 27, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//70000a19-e224-4a60-8544-4fc482534413_fe95370d6d0c8b62.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (47, 27, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//9b3866a8-3a67-4f01-82d2-3c63bdc35afe_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (48, 27, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//acb2cb00-10a7-4cf0-8eee-f1c731428634_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (49, 28, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//38774053-c95b-4f13-82fe-274a93cfc6cf_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (50, 28, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//e6d6e2c3-e58c-4e14-8305-942671390fdf_6a1b2703a9ed8737.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (51, 28, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//77da7bf9-3862-4c45-88d3-0c93e38fd3fb_63e862164165f483.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (52, 29, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//38774053-c95b-4f13-82fe-274a93cfc6cf_5b5e74d0978360a1.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (53, 29, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//e6d6e2c3-e58c-4e14-8305-942671390fdf_6a1b2703a9ed8737.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (54, 29, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//77da7bf9-3862-4c45-88d3-0c93e38fd3fb_63e862164165f483.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (55, 30, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//38774053-c95b-4f13-82fe-274a93cfc6cf_5b5e74d0978360a1.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (56, 30, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//e6d6e2c3-e58c-4e14-8305-942671390fdf_6a1b2703a9ed8737.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (57, 30, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//77da7bf9-3862-4c45-88d3-0c93e38fd3fb_63e862164165f483.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (58, 31, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//4cfb258f-aca4-4398-83df-e6a68fe2467d_23cd65077f12f7f5.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (59, 31, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//358f04d7-6869-4276-801e-cdcfe1d7efc9_e07b540657023162.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (60, 32, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//4cfb258f-aca4-4398-83df-e6a68fe2467d_23cd65077f12f7f5.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (61, 32, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//358f04d7-6869-4276-801e-cdcfe1d7efc9_e07b540657023162.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (62, 34, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//12c46e17-c7cf-45ad-81fc-ff80647d3efa_6ad2bfff1bddb38c.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (63, 34, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//d7719190-e7e4-47d9-821f-1d761ca72ecf_33421ec2f0ff03b0.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (64, 34, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1ef9127c-2a62-429b-86b1-4770bc116af1_d44b88e3bcaff342.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (65, 35, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//12c46e17-c7cf-45ad-81fc-ff80647d3efa_6ad2bfff1bddb38c.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (66, 35, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//d7719190-e7e4-47d9-821f-1d761ca72ecf_33421ec2f0ff03b0.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (67, 35, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1ef9127c-2a62-429b-86b1-4770bc116af1_d44b88e3bcaff342.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (68, 36, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//12c46e17-c7cf-45ad-81fc-ff80647d3efa_6ad2bfff1bddb38c.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (69, 36, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//d7719190-e7e4-47d9-821f-1d761ca72ecf_33421ec2f0ff03b0.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (70, 36, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1ef9127c-2a62-429b-86b1-4770bc116af1_d44b88e3bcaff342.jpg', NULL, 1);
...
CREATE TABLE `pms_sku_info`  (
  ...
  `sku_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'sku',
  `sku_desc` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'sku',
  `catalog_id` bigint(20) NULL DEFAULT NULL,
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT 'Ʒ',
  `sku_default_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Ĭ',
  `sku_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `sku_subtitle` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `price` decimal(18, 4) NULL DEFAULT NULL,
  `sale_count` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`sku_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (13, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 亮黑色 5G全网通8GB+128', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//8e2b617e-2216-4302-89da-2a3dd56cb0b6_28f296629cca865e.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 亮黑色 5G全网通8GB+128', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 5999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (14, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 亮黑色 5G全网通8GB+256GB', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3508e663-03cf-481c-8c9c-b95c5139a654_8bf441260bffa42f.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 亮黑色 5G全网通8GB+256GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 6299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (15, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 亮黑色 4G全网通8GB+256GB', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//8e2b617e-2216-4302-89da-2a3dd56cb0b6_28f296629cca865e.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 亮黑色 4G全网通8GB+256GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 5699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (16, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 亮黑色 4G全网通8GB+128GB', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//8e2b617e-2216-4302-89da-2a3dd56cb0b6_28f296629cca865e.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 亮黑色 4G全网通8GB+128GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 4999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (17, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 星河银 5G全网通8GB+128', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//c9f736ab-8bfa-47ae-845b-951320a5f94f_919c850652e98031.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 星河银 5G全网通8GB+128', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 5999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (18, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 星河银 5G全网通8GB+256GB', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//c9f736ab-8bfa-47ae-845b-951320a5f94f_919c850652e98031.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 星河银 5G全网通8GB+256GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 6299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (19, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 星河银 4G全网通8GB+256GB', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//efcabdcf-0f10-499a-880f-0ad159591a97_d511faab82abb34b.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 星河银 4G全网通8GB+256GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 5699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (20, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 星河银 4G全网通8GB+128GB', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//478ecda4-9b81-402c-89d1-4a6980dd8b7e_73ab4d2e818d2211.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 星河银 4G全网通8GB+128GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 4999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (21, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 翡冷翠 5G全网通8GB+128', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//073c6c6e-8b32-4cca-8b59-849189ef3356_23d9fbb256ea5d4a.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 翡冷翠 5G全网通8GB+128', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 5999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (22, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 翡冷翠 5G全网通8GB+256GB', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//073c6c6e-8b32-4cca-8b59-849189ef3356_23d9fbb256ea5d4a.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 翡冷翠 5G全网通8GB+256GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 6299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (23, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 翡冷翠 4G全网通8GB+256GB', NULL, 225, 2, NULL, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 翡冷翠 4G全网通8GB+256GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 5699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (24, 3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 翡冷翠 4G全网通8GB+128GB', NULL, 225, 2, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//027160aa-b076-41f0-82c7-176d41c1d471_b5c6b23d01dcdf81.jpg', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB 翡冷翠 4G全网通8GB+128GB', '【华为厂家直供/原装正品/现货速发】送品牌无线充+蓝牙耳机+三合一多功能数据线+蓝牙音箱+钢化膜等好礼！选购Mate30Pro（5G版）', 4999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (25, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 黑色 64GB', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//acb2cb00-10a7-4cf0-8eee-f1c731428634_a2c208410ae84d1f.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 黑色 64GB', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (26, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 黑色 128GB', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//9b3866a8-3a67-4f01-82d2-3c63bdc35afe_b8494bf281991f94.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 黑色 128GB', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 5199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (27, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 黑色 256G', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//acb2cb00-10a7-4cf0-8eee-f1c731428634_a2c208410ae84d1f.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 黑色 256G', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 5799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (28, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 红色 64GB', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//e6d6e2c3-e58c-4e14-8305-942671390fdf_6a1b2703a9ed8737.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 红色 64GB', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (29, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 红色 128GB', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//38774053-c95b-4f13-82fe-274a93cfc6cf_5b5e74d0978360a1.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 红色 128GB', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 5199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (30, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 红色 256G', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//38774053-c95b-4f13-82fe-274a93cfc6cf_5b5e74d0978360a1.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 红色 256G', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 5799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (31, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 白色 64GB', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//4cfb258f-aca4-4398-83df-e6a68fe2467d_23cd65077f12f7f5.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 白色 64GB', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (32, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 白色 128GB', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//4cfb258f-aca4-4398-83df-e6a68fe2467d_23cd65077f12f7f5.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 白色 128GB', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 5199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (33, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 白色 256G', NULL, 225, 4, NULL, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 白色 256G', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 5799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (34, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 蓝色 64GB', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1ef9127c-2a62-429b-86b1-4770bc116af1_d44b88e3bcaff342.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 蓝色 64GB', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (35, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 蓝色 128GB', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1ef9127c-2a62-429b-86b1-4770bc116af1_d44b88e3bcaff342.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 蓝色 128GB', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 5199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (36, 8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 蓝色 256G', NULL, 225, 4, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1ef9127c-2a62-429b-86b1-4770bc116af1_d44b88e3bcaff342.jpg', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机 蓝色 256G', '【限时特惠】加99元得20W快充头！加799得AirPods耳机！更多优惠！', 5799.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '˳',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 73 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (25, 13, 13, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (26, 13, 14, '版本', '5G全网通8GB+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (27, 14, 13, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (28, 14, 14, '版本', '5G全网通8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (29, 15, 13, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (30, 15, 14, '版本', '4G全网通8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (31, 16, 13, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (32, 16, 14, '版本', '4G全网通8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (33, 17, 13, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (34, 17, 14, '版本', '5G全网通8GB+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (35, 18, 13, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (36, 18, 14, '版本', '5G全网通8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (37, 19, 13, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (38, 19, 14, '版本', '4G全网通8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (39, 20, 13, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (40, 20, 14, '版本', '4G全网通8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (41, 21, 13, '颜色', '翡冷翠', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (42, 21, 14, '版本', '5G全网通8GB+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (43, 22, 13, '颜色', '翡冷翠', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (44, 22, 14, '版本', '5G全网通8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (45, 23, 13, '颜色', '翡冷翠', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (46, 23, 14, '版本', '4G全网通8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (47, 24, 13, '颜色', '翡冷翠', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (48, 24, 14, '版本', '4G全网通8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (49, 25, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (50, 25, 14, '版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (51, 26, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (52, 26, 14, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (53, 27, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (54, 27, 14, '版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (55, 28, 13, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (56, 28, 14, '版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (57, 29, 13, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (58, 29, 14, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (59, 30, 13, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (60, 30, 14, '版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (61, 31, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (62, 31, 14, '版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (63, 32, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (64, 32, 14, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (65, 33, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (66, 33, 14, '版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (67, 34, 13, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (68, 34, 14, '版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (69, 35, 13, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (70, 35, 14, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (71, 36, 13, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (72, 36, 14, '版本', '256G', NULL);
...
CREATE TABLE `pms_spu_comment`  (
  ...
  `member_ip` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `show_status` tinyint(1) NULL DEFAULT NULL,
  `spu_attributes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `likes_count` int(11) NULL DEFAULT NULL,
  `reply_count` int(11) NULL DEFAULT NULL,
  `resources` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `member_icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `comment_type` tinyint(4) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_spu_images`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `spu_id` bigint(20) NULL DEFAULT NULL COMMENT 'spu_id',
  `img_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ͼƬ',
  `img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ͼƬ',
  `img_sort` int(11) NULL DEFAULT NULL COMMENT '˳',
  `default_img` tinyint(4) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 106 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spuͼƬ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (15, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//ceff04ac-2eb0-4d20-8a2f-765039a47f25_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (16, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//ad3225bc-ca43-499c-84ba-de3bf1b2c033_1f15cdbcf9e1273c.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (17, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//5991b2ca-c1be-417c-8d49-eb173c7a3628_8bf441260bffa42f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (18, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//b366393b-8f11-45bb-80e0-ff3de664e9a5_8bf441260bffa42f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (19, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//d59284ec-8f7c-4528-8ec8-0f9985460a28_23d9fbb256ea5d4a.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (20, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//80d8f626-78fc-45ec-817d-504ec658b0fb_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (21, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//412f50ed-f549-4a46-8b67-683db9237f6e_73ab4d2e818d2211.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (22, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//2c5ec5e6-0c37-4882-8fa6-8723cdaaa567_919c850652e98031.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (23, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//f0dc385d-af2f-48fe-8e42-9d96d8f9270d_a83bf5250e14caf2.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (24, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//e4314d27-176b-407d-8939-ab5be9ea6da4_b5c6b23d01dcdf81.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (25, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//0c4b994d-4b4c-4ea9-8d84-0acb384749db_fe215589ed6500f4.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (26, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//205b53f2-4cf9-439d-8212-26c9852322d0_2b1837c6c50add30.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (27, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//02f0b4b9-824a-435b-8cda-891b81148fd7_3c24f9cd69534030.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (28, 2, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//f3739773-5d51-4e05-8476-c7bc475b9b1b_f753fc5c13707e7e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (29, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//78a19e33-5748-4275-8b5b-d4be53abd6e4_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (30, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//60f1ccc9-c480-4c2f-836e-505e88c02b29_1f15cdbcf9e1273c.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (31, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//34f5709c-7b9f-4805-83dd-b44177f937bf_2b1837c6c50add30.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (32, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1c0edda5-4c87-4082-8442-5ad58aa46cd4_3c24f9cd69534030.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (33, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//073c6c6e-8b32-4cca-8b59-849189ef3356_23d9fbb256ea5d4a.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (34, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//8e2b617e-2216-4302-89da-2a3dd56cb0b6_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (35, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3508e663-03cf-481c-8c9c-b95c5139a654_8bf441260bffa42f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (36, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//478ecda4-9b81-402c-89d1-4a6980dd8b7e_73ab4d2e818d2211.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (37, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//c9f736ab-8bfa-47ae-845b-951320a5f94f_919c850652e98031.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (38, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//027160aa-b076-41f0-82c7-176d41c1d471_b5c6b23d01dcdf81.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (39, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//efcabdcf-0f10-499a-880f-0ad159591a97_d511faab82abb34b.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (40, 3, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//cfcbf295-41be-498c-8773-bea32c18a56e_fe215589ed6500f4.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (93, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//3362084a-b1cd-46e7-8c51-573ef253f545_03c7bcc1f1e87699.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (94, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//12c46e17-c7cf-45ad-81fc-ff80647d3efa_6ad2bfff1bddb38c.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (95, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//6ce19483-3238-4691-879d-e87092e0346b_1831cb31ecb63f24.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (96, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//d7719190-e7e4-47d9-821f-1d761ca72ecf_33421ec2f0ff03b0.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (97, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1ef9127c-2a62-429b-86b1-4770bc116af1_d44b88e3bcaff342.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (98, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//70000a19-e224-4a60-8544-4fc482534413_fe95370d6d0c8b62.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (99, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//38774053-c95b-4f13-82fe-274a93cfc6cf_5b5e74d0978360a1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (100, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//e6d6e2c3-e58c-4e14-8305-942671390fdf_6a1b2703a9ed8737.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (101, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//77da7bf9-3862-4c45-88d3-0c93e38fd3fb_63e862164165f483.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (102, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//4cfb258f-aca4-4398-83df-e6a68fe2467d_23cd65077f12f7f5.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (103, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//9b3866a8-3a67-4f01-82d2-3c63bdc35afe_b8494bf281991f94.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (104, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//acb2cb00-10a7-4cf0-8eee-f1c731428634_a2c208410ae84d1f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (105, 8, NULL, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//358f04d7-6869-4276-801e-cdcfe1d7efc9_e07b540657023162.jpg', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `spu_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `spu_description` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `catalog_id` bigint(20) NULL DEFAULT NULL,
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT 'Ʒ',
  `weight` decimal(18, 4) NULL DEFAULT NULL,
  `publish_status` tinyint(4) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (3, '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB', '华为 HUAWEI Mate 30 Pro 5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄 丹霞橙 4G全网通8GB+256GB', 225, 2, 1.9800, 1, '2021-12-18 17:53:43', '2021-12-18 17:53:43');
INSERT INTO `pms_spu_info` VALUES (8, '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机', '苹果Apple iPhone 12 支持移动联通电信5G 双卡双待手机', 225, 4, 1.9200, 1, '2021-12-19 09:12:22', '2021-12-19 09:12:22');
...
CREATE TABLE `pms_spu_info_desc`  (
  ...
  `decript` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  PRIMARY KEY (`spu_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info_desc
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (3, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//89744134-8a1f-45d1-8441-d3a93fa38a42_528211b97272d88a.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (8, 'https://lm--gulimall.oss-cn-shanghai.aliyuncs.com/2021-12-19//1abe834c-1e59-4b3b-8851-339bf9772597_17565e464b9e554e.jpg');
